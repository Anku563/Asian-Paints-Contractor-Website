...
*/
    ...
    INSPIRO.carouselInspiro = function () {
        ...
        if ($("#project-slider-carousel").exists()) {
            $("#project-slider-carousel").each(function () {
                $("#project-slider-carousel").owlCarousel({
                    margin: 0,
                    loop: true,
                    nav: true,
                    navText: ['<i class="fa fa-arrow-left icon-white"></i>',
                ...
                var owl = $("#project-slider-carousel");
                ...
                owl.on('changed.owl.carousel', function (event) {
                    ...
                    //stop embed videos if they exists
                    if ($("#project-slider-carousel .owl-item.active .slider-content iframe").length) {
                        var url = $("#project-slider-carousel .owl-item.active .slider-content iframe").attr("src");
                        $('iframe').attr('src', '');
                        $('iframe').attr('src', url);
        ...
        if ($("#completed_project-slider-carousel").exists()) {
            $("#completed_project-slider-carousel").each(function () {
                $("#completed_project-slider-carousel").owlCarousel({
                    margin: 0,
                    loop: true,
                    nav: true,
                    navText: ['<i class="fa fa-arrow-left icon-white"></i>',
                ...
                var owl = $("#completed_project-slider-carousel");
                ...
                owl.on('changed.owl.carousel', function (event) {
                    ...
                    //stop embed videos if they exists
                    if ($("#completed_project-slider-carousel .owl-item.active .slider-content iframe").length) {
                        var url = $("#completed_project-slider-carousel .owl-item.active .slider-content iframe").attr("src");
                        $('iframe').attr('src', '');
                        $('iframe').attr('src', url);
