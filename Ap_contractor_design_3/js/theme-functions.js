...
*/
    ...
    INSPIRO.carouselInspiro = function () {
        ...
        if ($(".owl-slider-style4").exists()) {
            $(".owl-slider-style4").each(function () {
                ...
                owl.on('changed.owl.carousel', function (event) {
                    ...
                    //stop embed videos if they exists
                    if ($(".owl-slider-style4 .owl-item.active .slider-content iframe").length) {
                        var url = $(".owl-slider-style4 .owl-item.active .slider-content iframe").attr("src");
                        $('iframe').attr('src', '');
                        $('iframe').attr('src', url);
